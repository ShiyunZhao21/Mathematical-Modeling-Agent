...
class NotebookSerializer:
    def __init__(self, work_dir=None, notebook_name="solution.ipynb"):
    ...
    def init_notebook(self, work_dir=None, notebook_name="solution.ipynb"):
        """初始化notebook路径

        Args:
            work_dir (str): jupyter工作目录路径
            notebook_name (str): notebook文件名,默认为solution.ipynb
        """
        if work_dir:
            # 确保使用jupyter工作目录
    ...
    def export_code_script(self, script_name="solution.py"):
        """Export executed code cells to a standalone Python script."""
        if not self.notebook_path:
            raise ValueError("Notebook path is not initialized")

        script_path = os.path.join(os.path.dirname(self.notebook_path), script_name)
        code_cells = [
            cell["source"]
        ...
        header = (
            "# Auto-generated by MathModelAgent backend\n"
            "# This file contains the executed code cells in task order.\n\n"
        )
        blocks = []
