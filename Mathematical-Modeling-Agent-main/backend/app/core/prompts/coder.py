...
**Key Skills**: pandas, numpy, seaborn, matplotlib, scikit-learn, xgboost, scipy, statsmodels
...
plt.rcParams['font.sans-serif'] = ['Microsoft YaHei', 'SimHei', 'Noto Sans CJK SC', 'Source Han Sans SC', 'WenQuanYi Micro Hei', 'Arial Unicode MS', 'DejaVu Sans']
...
## 图片文件命名（强制）
- 所有图片必须保存为稳定、语义化文件名，推荐格式：`section_semantic_name.png`
